...
for ITER in range(args.epochs):
  ...
  for ii in pbar:
    ...
    if args.val_freq != 0 and done % args.val_freq == 0:
      print("")
      val_score, val_rate = evaluate(filter_net, net, dev, CNN, config, experiment_log, verbose = False, annid2catid = annid2catid)
  ...
  val_score, val_rate = evaluate(filter_net, net, dev, CNN, config, experiment_log, verbose = args.verbose, annid2catid = annid2catid)
